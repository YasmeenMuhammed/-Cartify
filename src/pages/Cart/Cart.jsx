        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white border border-gray-200 rounded-2xl sticky top-24 overflow-hidden shadow-md">
                  ...
                  {totalCartPrice < 500 ? <>
                    <div className="bg-linear-to-r from-orange-50 to-amber-50 rounded-xl p-4">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <div className="text-sm font-semibold text-orange-600">Add {`${Math.min(500 - totalCartPrice?.toFixed(0))}`} EGP for free shipping</div>
                      </div>
                    </div>
                  </> : <>
                    <div className="bg-linear-to-r from-green-50 to-amber-50 rounded-xl p-4">
                      <div className="flex items-center gap-2 mb-2">
                        <FaTruck className={`text-green-600`} />
                        <div className="text-sm font-semibold text-green-600">You Unlocked Free Shipping!</div>
                      </div>
                    </div>
                  </>}
                  {
                ...
                <div className="p-4 space-y-3">
                  <div className="space-y-3">
                    <div className="flex justify-between text-gray-600 mt-4">
                      <span>SubTotal:</span>
                      <span className='font-medium text-gray-900'>EGP {totalCartPrice.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between text-gray-600">
                      <span>Shipping:</span>
                      <span className='font-medium text-gray-900'>EGP 50</span>
                    </div>
                    <div className="border-t border-dashed border-gray-200 pt-3 mt-3 ">
                      <div className="flex justify-between items-baseline">
                        <span className='text-gray-900 font-semibold'>Total:</span>
                        <span className='font-bold text-lg'>EGP {(totalCartPrice + 50).toFixed(2)}</span>
                      </div>
                    </div>
                  </div>
