      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-linear-to-br from-violet-50 to-violet-200 rounded-lg p-6 ">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h4 className='font-semibold text-gray-900'>Buyer Protection Guarantee</h4>
          </div>
          <ul className='space-y-3'>
            <li className='flex items-center gap-2 text-sm text-gray-700'>
              <FaCheck className='text-violet-600 text-lg' />
              <span>Get a full refund if your order doesn't arrive or isn't as described.
                We ensure your shopping experience is safe and secure.</span>
